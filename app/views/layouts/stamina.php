...
use fw\core\base\View;
 ...
 View::getMeta();?>
  ...
  <link rel="stylesheet" href="/stamina/css/bootstrap.min.css">
  <link rel="stylesheet" href="/stamina/css/jquery-ui.css">
  <link rel="stylesheet" href="/stamina/css/owl.carousel.min.css">
  <link rel="stylesheet" href="/stamina/css/owl.theme.default.min.css">
  <link rel="stylesheet" href="/stamina/css/owl.theme.default.min.css">

  <link rel="stylesheet" href="/stamina/css/jquery.fancybox.min.css">

  <link rel="stylesheet" href="/stamina/css/bootstrap-datepicker.css">

  <link rel="stylesheet" href="/stamina/fonts/flaticon/font/flaticon.css">

  <link rel="stylesheet" href="/stamina/css/aos.css">
  <link href="/stamina/css/jquery.mb.YTPlayer.min.css" media="all" rel="stylesheet" type="text/css">
...
<!-- SITEBAR -->
    ...
    <div class="bgimg" style="background-image: url('/stamina/images/bg_2.jpg');"  data-stellar-background-ratio="0.5">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="class-item d-flex align-items-center">
              <a href="/stamina/single.html" class="class-item-thumbnail">
                <img src="/stamina/images/img_1.jpg" alt="Image">
              </a>
              <div class="class-item-text">
                
                <h2><a href="/stamina/single.html">Fitness Class Name #1</a></h2>
            ...
            <div class="class-item d-flex align-items-center">
              <a href="/stamina/single.html" class="class-item-thumbnail">
                <img src="/stamina/images/img_2.jpg" alt="Image">
              </a>
              <div class="class-item-text">
                
                <h2><a href="/stamina/single.html">Fitness Class Name #2</a></h2>
                <span>By Justin Daniel</span>,
                <span>30 minutes</span>
              </div>
            </div>
            ...
            <div class="class-item d-flex align-items-center">
              <a href="/stamina/single.html" class="class-item-thumbnail">
                <img src="/stamina/images/img_3.jpg" alt="Image">
              </a>
              <div class="class-item-text">
                
                <h2><a href="/stamina/single.html">Fitness Class Name #3</a></h2>
                <span>By Justin Daniel</span>,
                <span>30 minutes</span>
              </div>
            </div>
            ...
            <div class="class-item d-flex align-items-center">
              <a href="/stamina/single.html" class="class-item-thumbnail">
                <img src="/stamina/images/img_4.jpg" alt="Image">
              </a>
              <div class="class-item-text">
                
                <h2><a href="/stamina/single.html">Fitness Class Name #4</a></h2>
                <span>By Justin Daniel</span>,
                <span>30 minutes</span>
              </div>
            </div>
            ...
            <div class="class-item d-flex align-items-center">
              ...
              <div class="class-item-text">
                ...
                <h2><a href="/stamina/single.html">Fitness Class Name #5</a></h2>
                <span>By Justin Daniel</span>,
                <span>30 minutes</span>
              </div>
            </div>
    ...
    <div class="bgimg" style="background-image: url('/stamina/images/bg_3.jpg');"  data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-7">
    ...
    <div class="bgimg" style="background-image: url('/stamina/images/bg_1.jpg');" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-7">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-3 mb-4 mb-lg-0 col-md-6 text-center" data-aos="fade-up" data-aos-delay="">
            <div class="person">
              <img src="/stamina/images/person_1.jpg" alt="Image" class="img-fluid">
              <h3>Justin Daniel</h3>
          ...
          <div class="col-lg-3 mb-4 mb-lg-0 col-md-6 text-center" data-aos="fade-up" data-aos-delay="100">
            <div class="person">
              <img src="/stamina/images/person_3.jpg" alt="Image" class="img-fluid">
          ...
          <div class="col-lg-3 mb-4 mb-lg-0 col-md-6 text-center" data-aos="fade-up" data-aos-delay="200">
            <div class="person">
              <img src="/stamina/images/person_2.jpg" alt="Image" class="img-fluid">
              <h3>Matthew Davidson</h3>
              <p class="position">Trainer</p>
              <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind
                texts.</p>
          ...
          <div class="col-lg-3 mb-4 mb-lg-0 col-md-6 text-center" data-aos="fade-up" data-aos-delay="300">
            <div class="person">
              <img src="/stamina/images/person_4.jpg" alt="Image" class="img-fluid">
              <h3>Matthew Davidson</h3>
              <p class="position">Trainer</p>
              <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind
                texts.</p>
  ...
  <script src="/stamina/js/jquery-3.3.1.min.js"></script>
  <script src="/stamina/js/jquery-migrate-3.0.1.min.js"></script>
  <script src="/stamina/js/jquery-ui.js"></script>
  <script src="/stamina/js/popper.min.js"></script>
  ...
  <script src="/stamina/js/jquery.countdown.min.js"></script>
  <script src="/stamina/js/bootstrap-datepicker.min.js"></script>
  <script src="/stamina/js/jquery.easing.1.3.js"></script>
  <script src="/stamina/js/aos.js"></script>
  <script src="/stamina/js/jquery.fancybox.min.js"></script>
  <script src="/stamina/js/jquery.sticky.js"></script>
  <script src="/stamina/js/jquery.mb.YTPlayer.min.js"></script>
